...
export const ERROR_CATALOG = {
  ...
  DEVICE_RADIUS_SECRET_NOT_SET: { httpStatus: 404, retryable: false },
  ...
  RADIUS_SECRET_ENCRYPTION_UNAVAILABLE: { httpStatus: 422, retryable: false },
  RADIUS_SECRET_DECRYPT_FAILED: { httpStatus: 422, retryable: false },
